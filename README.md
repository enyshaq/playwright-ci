...
- Каталог: товары отображаются, сортировка (по цене/имени), добавить в корзину 
- Оформление заказа: полный флоу: товар → checkout → данные → Finish → «Thank you» ✓; пустые поля формы ✗
